<template>
  <div class="newsletter-wrapper">
    ...
    <div class="newsletter-info">
      Nie przegap okazji, dołącz do naszego newslettera.
    </div>
...
.newsletter-wrapper {
  ...
  .input-group {
    input {
      ...
      &:focus {
        box-shadow: 0px 0px 10px $newsletter-button-color;
      }
    ...
    button {
      min-width: 190px;
      padding: 3px 20px 0;
      background-color: $newsletter-button-color;
      display: flex;
      flex-direction: row;
      ...
      &:hover {
        background-color: rgba($newsletter-button-color, 0.9);
        .icon {
          margin-right: 4px;
        }
      }
